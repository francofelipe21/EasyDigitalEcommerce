...
function writeCustomSearchCoordinatedFromMap(lat, lng){
	...
	window.parent.document.querySelector("#p_coordinates").innerHTML = "Coordenadas<br> Longitud: " + lng + "<br> Latitud: " + lat
	//window.parent.document.querySelector("#other_location").innerText = "Deseleccionar ubicación escogida del mapa";
}